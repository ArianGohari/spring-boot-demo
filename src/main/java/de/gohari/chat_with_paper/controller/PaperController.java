...
public class PaperController {
    ...
    public ResponseEntity<Resource> download(@PathVariable("id") String id) {
        ...
        // Try to load the file for given paper id and return it with HTTP ok if successful
        try {
    ...
    public ResponseEntity<Resource> downloadThumbnail(@PathVariable("paperId") String paperId) {
        ...
        // Try to load the thumbnail for given paper id and return it with HTTP ok if successful
        try {
